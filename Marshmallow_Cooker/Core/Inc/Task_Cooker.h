...
private:
  ...
  static constexpr int32_t kDoneMarshmallowTempFx100 = 25000; ///< Done IR object temperature, 240.00 F.
  static constexpr uint32_t kDoneTempHoldTimeMs = 1500; ///< Required continuous time above done IR temperature.
