...
#define I2CBB_ERROR_NACK_WRITE_ADDR 0x20UL
#define I2CBB_ERROR_NACK_REG_ADDR 0x40UL
#define I2CBB_ERROR_NACK_READ_ADDR 0x80UL
...
typedef enum { SPEED_100k = 0, SPEED_400k = 1, SPEED_50k = 2, SPEED_10k = 3 } i2cbbSpeed_t;
...
private:
  ...
  struct t /*timing according to i2c standards*/
  {
    ...
    uint16_t sudat; // the minimum amount of time required for SDA to have reached a stable level before an SCL
